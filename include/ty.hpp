...
L_DEF_FMT(R8_UINT,             1, CU_AD_FORMAT_UNSIGNED_INT8);
L_DEF_FMT(R8G8_UINT,           2, CU_AD_FORMAT_UNSIGNED_INT8);
L_DEF_FMT(R8G8B8_UINT,         3, CU_AD_FORMAT_UNSIGNED_INT8);
L_DEF_FMT(R8G8B8A8_UINT,       4, CU_AD_FORMAT_UNSIGNED_INT8);
